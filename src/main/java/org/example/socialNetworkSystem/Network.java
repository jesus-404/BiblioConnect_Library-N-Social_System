...
public class Network {
    ...
    public Network() {
        ...
        this.searchedPatronDoc = new Document();
        this.signedInPatronDoc = new Document();
        this.signedIn = false;
    }

    //Get user's favorite books
    public void profileFavBooks() {
        //Get patron info
        Document patronDoc = getPatronDoc();
    ...
    public void profileFriendsList() {
        //Get patron info
        Document patronDoc = getPatronDoc();
    ...
    public boolean searchPatron(String patronId) {
        try {
            Document patronDoc = patronCol.find(Filters.eq("_id", Integer.parseInt(patronId))).first();
            if (patronDoc == null) {
                clearScreen();
                System.err.println("Error: Incorrect ID");
                return false;
            }
            searchedPatronDoc = patronDoc;
            return true;
    ...
    public String getPatronName() {
        return signedIn ? signedInPatronDoc.getString("name") : searchedPatronDoc.getString("name");
    }
